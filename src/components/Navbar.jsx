...
//                   <Link
//                     href={item.href}
//                     className="text-amber-600 hover:text-amber-600 px-3 py-2 rounded-md text-sm font-medium transition-colors"
//                   >
//                     {item.name}
//                   </Link>
//                 </motion.div>
...
//                       setIsOpen(false)
//                     }}
//                     className="block w-full text-left px-3 py-2 text-gray-700 hover:text-red-600 hover:bg-red-50 rounded-md transition-colors"
//                   >
//                     Logout
//                   </button>
//                 </div>
...
//                   <Link
//                     href="/auth/login"
//                     className="block px-3 py-2 text-center bg-amber-600 text-white rounded-md hover:bg-amber-700 transition-colors"
//                     onClick={() => setIsOpen(false)}
//                   >
//                     Login
//                   </Link>
//                   <Link
//                     href="/auth/register"
//                     className="block px-3 py-2 text-center border border-amber-600 text-amber-600 rounded-md hover:bg-amber-50 transition-colors"
//                     onClick={() => setIsOpen(false)}
//                   >
//                     Register
//                   </Link>
